...
export default function EditTAEnrollment() {
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               ...
               const response = await axios.post(`/api/edit-taSchedule/${id}`, {
                    ...informationTA, fullName: information.fullName, gpaSubject: information.gpaSubject,
                    gpaTotal: information.gpaTotal, studentId: information.studentId,  id:information._id
               }, {
     ...
     useEffect(() => {
          const getINF = async () => {
               try {
                    ...
                    const res = await axios.get(`/api/taScheduleEdit/${id}`, {
                         headers: { Authorization: auth.accesstoken },
                    })
     ...
     if (editForm) return (
          <div className="flex justify-center flex-col items-center h-[80vh]">
               ...
               <Button
                    ...
                    className='mx-2 mt-2'
                    radius='sm'
                    onClick={() => { navigate("/edit-applyTA", { replace: true }) }}
               >
                    Edit Form
               </Button>
