        ...
        <div id={`image${id}`} className="carousel slide" data-ride="carousel">
            ...
            
            {
                ...
                <>
                    ...
                    style={{width: '5%'}}>
                        <span className="carousel-control-prev-icon bg-slate-400 p-[12px] rounded-xl" aria-hidden="true"></span>
                        <span className="sr-only">Previous</span>
                    </a>

                    <a className="carousel-control-next" href={`#image${id}`} role="button" data-slide="next"
                    style={{width: '5%'}}>
                        <span className="carousel-control-next-icon bg-slate-400 p-[12px] rounded-xl" aria-hidden="true"></span>
