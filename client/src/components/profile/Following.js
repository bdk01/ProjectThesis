    ...
    return (
        <div className="fixed top-0 left-0 bg-[#0008] w-[100%] h-[100vh] z-[50]">
            <div className="w-[350px]  rounded-sm bg-white relative top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]">
              <div className="absolute t-0 right-2  text-2xl cursor-pointer" onClick={() => setShowFollowing(false)}>
                    &times;
                </div>
                <h5 className="text-center text-lg pb-1 pt-1 border-b-[1px] border-black">Following</h5>
                <hr/>
